        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary border border-border mb-6">
              ...
              <span className="text-xs font-mono text-muted-foreground">SYSTEMS_ENGINEER // DOMINICAN_REPUBLIC</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
              Building <span className="text-primary font-mono">&lt;Enterprise/&gt;</span> Systems
            </h1>
            
            <p className="text-lg text-muted-foreground mb-8 max-w-xl leading-relaxed">
              I'm Jesus Garcia. I architect and deploy production-grade ERPs, full-stack applications, and deep fiscal integrations. When businesses need infrastructure that doesn't fail, they call me.
            </p>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 border-t border-border pt-8">
              <div>
                <div className="flex items-center gap-2 text-foreground font-mono font-bold mb-1">
                  <Database className="w-4 h-4 text-primary" /> ERP
                </div>
                <div className="text-sm text-muted-foreground">Odoo / Custom</div>
              </div>
              <div>
                <div className="flex items-center gap-2 text-foreground font-mono font-bold mb-1">
                  <LayoutTemplate className="w-4 h-4 text-primary" /> DGII
                </div>
                <div className="text-sm text-muted-foreground">Fiscal Suite</div>
              </div>
              <div>
                <div className="flex items-center gap-2 text-foreground font-mono font-bold mb-1">
                  <Code2 className="w-4 h-4 text-primary" /> Stack
                </div>
                <div className="text-sm text-muted-foreground">TS / Python</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            {/* Decorative technical elements behind image */}
